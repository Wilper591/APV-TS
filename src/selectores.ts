...
export const propietarioInput = document.querySelector(
  "#propietario"
) as HTMLInputElement;
...
export const sintomasInput = document.querySelector(
  "#sintomas"
) as HTMLInputElement;
...
export const contenedorCitas = document.querySelector(
  "#citas"
) as HTMLDivElement;
